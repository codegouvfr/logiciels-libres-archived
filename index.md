...
# Les objectifs, engagements et rituels de la mission logiciels libres

Voir la [page dédiée](mission-logiciels-libres.md).
...
Nous articulons tout ce que nous faisons autour de *produits* (logiciels, services en ligne, ressources).  Ceux-ci servent notre mission et reflètent nos [engagements](mission-logiciels-libres.md#engagements).
...
# Comment suivre les activités de la mission logiciels libres ?
...
Les [ateliers BlueHats](https://communs.numerique.gouv.fr/ateliers/) animés par la mission logiciels libres permettent de découvrir des solutions libres déployées dans des administrations.
